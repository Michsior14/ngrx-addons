...
This was a version bump only for persist-state to align it with other projects, there were no code changes.
...
**Note:** Version bump only for package @ngrx-addons/persist-state
